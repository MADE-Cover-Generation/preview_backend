...
from models.maniqa.model_provider import ModelProvider
from model_utils import ToTensor, Normalize

class Inferencer:

    CROP_SIZE = 224

    def __init__(self, model_provider: ModelProvider, frame_extractor: FrameExtractor, output_folder: str) -> None:
        self.output_folder = output_folder
        self.model = model_provider.get_maniqa_model()
        self.frame_extractor = frame_extractor

    def maniqa_inference(self, path_to_video: str) -> str:
    ...
    def crop_image(self, top, left, patch_size, img=None):
